...
def checkWordNum(string, p, l):
    foundInNum_1, foundInNum_2, foundInNum_3 = [False, False, False]
    if l:
        try:
            if string[p:p+3] in nums_1:
                return nums_1[string[p:p+3]]
            elif string[p:p+4] in nums_2:
                return nums_2[string[p:p+4]]
            elif string[p:p+5] in nums_3:
                return nums_3[string[p:p+5]]
        except:
            pass
        ...
        try:
            foundInNum_1 = string[p-3:p] in nums_1
            foundInNum_2 = string[p-4:p] in nums_2
            foundInNum_3 = string[p-5:p] in nums_3
        except:
            pass
...
for i in strings:
    ...
    find_l = False
    find_r = False
    find_both = find_l and find_r

    while r_p >= l_p and not find_both:
        
        num1=checkWordNum(i,l_p,True)
        if checkIfNum(i[l_p]) or num1:
            find_l = True
            
        elif not find_l:
            l_p += 1
        
        if checkIfNum(i[r_p]) or checkWordNum(i,l_p,False):
            find_r = True
